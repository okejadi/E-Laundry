        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-user"></i> Tambah Paket Laundry</h6>
            </div>
            <div class="card-body">
              <form method="post" action="">
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="nama" name="nama_paket" placeholder="Nama Paket">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="" class="form-control" id="harga" name="tarif_paket" placeholder="Harga Paket">
                  </div>
                </div>
