<?php if(!defined('akses')){ 
      ...
      //query for tables
      $query="SELECT id_akun, nama,email, alamat, no_telepon, is_active from akun where level='customer'";
      $result = $admin->ambilData($query);
      if(isset($_GET['hapus'])){
        $admin->Hapus($_GET['hapus'],"customer");
      }
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-user"></i> Data Customer</h6>
            </div>
            <div class="card-body">
              <p class="align-left">
                <a class="btn btn-sm btn-icon-split btn-primary" href="<?php echo $working_dir;?>/customer/tambah">
                  <span class="icon">
                ...
                <table class="table " id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    foreach($result as $data){ 
                      ...
                      echo "<td class='align-middle'>".$data['email']."</td>";
                      echo "<td class='align-middle'>".$data['alamat']."</td>";
                      echo "<td class='align-middle'>".$data['no_telepon']."</td>";
                      echo "<td class='align-middle'>".$tipe."</td>";
                      echo "<td><a type='button' class='btn btn-sm btn-primary btn-icon-split' href='".$working_dir."/customer/edit?id=".$data['id_akun']."'>
                            <span class='icon text-white-50'><i class='fas fa-info'></i></span>
                            <span class='text'>Edit</span>
                          </a>
                          <a type='button' class='btn btn-sm btn-danger btn-icon-split' href='".$working_dir."/customer?hapus=".$data['id_akun']."'>
